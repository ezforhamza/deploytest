// src/components/dashboard/SchoolsContent.jsx

import React from "react";
import { colors } from "../../styles/tokens";

const SchoolsContent = ({ userRole, searchValue }) => {
  return (
      ...
      <div className="w-full max-w-[554px]">
        ...
        >
          ...
          <p className="text-gray-600 font-lexend text-sm sm:text-base">
            Connect with your alma mater and discover other educational institutions.
          </p>
        </div>
      </div>
    </div>
