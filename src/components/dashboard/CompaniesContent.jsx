// src/components/dashboard/CompaniesContent.jsx

import React from "react";
import { colors } from "../../styles/tokens";

const CompaniesContent = ({ userRole, searchValue }) => {
  return (
      ...
      <div className="w-full max-w-[554px]">
        ...
        >
          ...
          <p className="text-gray-600 font-lexend text-sm sm:text-base">
            Partner companies and organizations that work with your institution.
          </p>
        </div>
      </div>
    </div>
