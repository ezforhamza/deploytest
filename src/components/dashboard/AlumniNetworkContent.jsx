// src/components/dashboard/AlumniNetworkContent.jsx

import React from "react";
import { colors } from "../../styles/tokens";

const AlumniNetworkContent = ({ userRole, searchValue }) => {
  return (
      ...
      <div className="w-full max-w-[554px]">
        ...
        >
          ...
          <p className="text-gray-600 font-lexend text-sm sm:text-base">
            Connect with and recruit from our extensive alumni network.
          </p>
        </div>
      </div>
    </div>
...
export default AlumniNetworkContent;